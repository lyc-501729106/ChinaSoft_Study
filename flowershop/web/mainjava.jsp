            ...
            <div id="content" class="right">
                ...
                %>
                    ...
                    <div class="product_box">
                        <a href="DetailServlet?fid=<%=f.getFid()%>"><img src=<%=f.getPic()%> alt="此处是鲜花" /></a>
                        <h3><%=f.getFlowername()%></h3>
                        <p class="product_price"><%=f.getPrice()%></p>
                        <p class="add_to_cart">
                            <a href="DetailServlet?fid=<%=f.getFid()%>">详情</a>
                            <a href="AddCarServlet?fid=<%=f.getFid()%>">添加到购物车</a>
                        </p>
                    </div>
