...
<body class="template-color-1">
    ...
    <div class="main-wrapper">
                                    ...
                                    <div class="single-slide animation-style-03 bg-5">
                                        <div class="container">
                                            <div class="slider-content">
                                                <h4>One Day Only</h4>
                                                <h3>The Egg Chair</h3>
                                                <span>10% of selected Living Room</span>
                                                <div class="umino-btn-ps_left slide-btn">
                                                    <a class="umino-slider_btn" href="shop-left-sidebar.jsp">Shop Now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="banner-item img-hover_effect">
                                    <div class="banner-content">
                                        ...
                                        <div class="umino-btn-ps_center">
                                            <a class="umino-btn umino-btn_dark" href="shop-left-sidebar.jsp">Shop Now</a>
                                        </div>
                                    </div>
                ...
                <div class="row">
                        ...
                        <div class="banner-item img-hover_effect">
                            <div class="banner-content">
                                ...
                                <div class="umino-btn-ps_left">
                                    <a class="umino-btn umino-btn_dark umino-btn_red" href="shop-left-sidebar.jsp">Shop Now</a>
                                </div>
                            </div>
                            <div class="banner-img">
                                <a href="javascript:void(0)">
                                    <img class="img-full" src="assets/images/banner/3-2.jpg" alt="Umino's Banner">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="banner-item img-hover_effect">
                            ...
                            <div class="banner-img">
                                <a href="javascript:void(0)">
                                    <img class="img-full" src="assets/images/banner/3-3.jpg" alt="Umino's Banner">
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Umino's Shipping Area End Here -->
                                        ...
                                        <div class="col-lg-2 col-md-2 order-3">
                                            <div class="product-tab_wrap">
                                                <div class="product-tab">
                                                    <ul class="nav">
                                                        <li><a class="active" data-toggle="tab" href="#one"><img src="assets/images/product/small-size/1.jpg" alt="Umino's Product Image"></a>
                                                        </li>
                                                        <li><a data-toggle="tab" href="#two"><img src="assets/images/product/small-size/2.jpg" alt="Umino's Product Image"></a></li>
                                                        <li><a data-toggle="tab" href="#three"><img src="assets/images/product/small-size/3.jpg" alt="Umino's Product Image"></a></li>
                                                        <li><a data-toggle="tab" href="#four"><img src="assets/images/product/small-size/4.jpg" alt="Umino's Product Image"></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="tab-content">
                                                <div id="one" class="tab-pane active show" role="tabpanel">
                                                    <div class="product-img">
                                                        <a href="single-product.jsp">
                                                            <img class="primary-img" src="assets/images/product/large-size/1.jpg" alt="Umino's Product Image">
                                                        </a>
                                                ...
                                                <div id="two" class="tab-pane" role="tabpanel">
                                                    <div class="product-img">
                                                        <a href="single-product.jsp">
                                                            <img class="primary-img" src="assets/images/product/large-size/2.jpg" alt="Umino's Product Image">
                                                        </a>
                                                        <div class="add-actions">
                                                            <ul>
                                                                <li><a href="cart.jsp" data-toggle="tooltip" data-placement="top" title="Add To cart"><i
                                                ...
                                                <div id="three" class="tab-pane" role="tabpanel">
                                                    <div class="product-img">
                                                        <a href="single-product.jsp">
                                                            <img class="primary-img" src="assets/images/product/large-size/3.jpg" alt="Umino's Product Image">
                                                        </a>
                                                        <div class="add-actions">
                                                            <ul>
                                                                <li><a href="cart.jsp" data-toggle="tooltip" data-placement="top" title="Add To cart"><i
                                                ...
                                                <div id="four" class="tab-pane" role="tabpanel">
                                                    <div class="product-img">
                                                        <a href="single-product.jsp">
                                                            <img class="primary-img" src="assets/images/product/large-size/4.jpg" alt="Umino's Product Image">
                                                        </a>
                                                        <div class="add-actions">
                                                            <ul>
                                                                <li><a href="cart.jsp" data-toggle="tooltip" data-placement="top" title="Add To cart"><i
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2 col-md-2 order-3">
                                            <div class="product-tab_wrap">
                                                <div class="product-tab">
                                                    <ul class="nav">
                                                        <li><a class="active" data-toggle="tab" href="#five"><img src="assets/images/product/small-size/5.jpg" alt="Umino's Product Image"></a>
                                                        </li>
                                                        <li><a data-toggle="tab" href="#six"><img src="assets/images/product/small-size/6.jpg" alt="Umino's Product Image"></a></li>
                                                        <li><a data-toggle="tab" href="#seven"><img src="assets/images/product/small-size/7.jpg" alt="Umino's Product Image"></a></li>
                                                        <li><a data-toggle="tab" href="#eight"><img src="assets/images/product/small-size/8.jpg" alt="Umino's Product Image"></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-5 order-2">
                                            <div class="tab-content">
                                                <div id="five" class="tab-pane active show" role="tabpanel">
                                                    <div class="product-img">
                                                        <a href="single-product.jsp">
                                                            <img class="primary-img" src="assets/images/product/large-size/5.jpg" alt="Umino's Product Image">
                                                        </a>
                                                        <div class="add-actions">
                                                            <ul>
                                                                <li><a href="cart.jsp" data-toggle="tooltip" data-placement="top" title="Add To cart"><i
                                                ...
                                                <div id="six" class="tab-pane" role="tabpanel">
                                                    <div class="product-img">
                                                        <a href="single-product.jsp">
                                                            <img class="primary-img" src="assets/images/product/large-size/6.jpg" alt="Umino's Product Image">
                                                        </a>
                                                        <div class="add-actions">
                                                            <ul>
                                                                <li><a href="cart.jsp" data-toggle="tooltip" data-placement="top" title="Add To cart"><i
                                                ...
                                                <div id="seven" class="tab-pane" role="tabpanel">
                                                    <div class="product-img">
                                                        <a href="single-product.jsp">
                                                            <img class="primary-img" src="assets/images/product/large-size/7.jpg" alt="Umino's Product Image">
                                                        </a>
                                                        <div class="add-actions">
                                                            <ul>
                                                                <li><a href="cart.jsp" data-toggle="tooltip" data-placement="top" title="Add To cart"><i
                                                ...
                                                <div id="eight" class="tab-pane" role="tabpanel">
                                                    <div class="product-img">
                                                        <a href="single-product.jsp">
                                                            <img class="primary-img" src="assets/images/product/large-size/8.jpg" alt="Umino's Product Image">
                                                        </a>
                                                        <div class="add-actions">
                                                            <ul>
                                                                <li><a href="cart.jsp" data-toggle="tooltip" data-placement="top" title="Add To cart"><i
                        ...
                        <div class="col-lg-12">
                            <div class="product-tab">
                                <ul class="nav product-menu">
                                    <li><a class="active" data-toggle="tab" href="#featured"><span>Featured</span></a></li>
                                    <li><a data-toggle="tab" href="#new-arrivals"><span>New Arrivals</span></a></li>
                                    <li><a data-toggle="tab" href="#best-seller"><span>Best Seller</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="umino-product-tab_slider slider-navigation_style-1">
                                    ...
                                    <div class="slide-item">
                                        <div class="single-product">
                                            <div class="product-img">
                                                <a href="single-product.jsp">
                                                    <img class="primary-img" src="assets/images/product/medium-size/8-1.jpg" alt="Umino's Product Image">
                                                </a>
                                                <div class="add-actions">
                                                    <ul>
                                                        <li><a href="cart.jsp" data-toggle="tooltip" data-placement="top" title="Add To cart"><i class="ion-bag"></i></a>
        ...
        <div class="umino-banner_area umino-banner_area-6">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="umino-banner img-hover_effect">
                            <a href="shop-left-sidebar.jsp">
                                <img src="assets/images/banner/3-4.jpg" alt="Umino's Banner">
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="umino-list-product_area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="list-product_slider slider-navigation_style-1">
                            <div class="slide-item">
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="shop-left-sidebar.jsp">
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            ...
                                            <h6 class="product-name"><a href="single-product.jsp">Aliquam porttitor turpis</a>
                                            </h6>
                                            <div class="rating-box">
                                                <ul>
                                                    <li><i class="ion-ios-star"></i></li>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            ...
                                            <h6 class="product-name"><a href="single-product.jsp">Condime eondim furnitur</a>
                                            </h6>
                                            <div class="rating-box">
                                                <ul>
                                                    <li><i class="ion-ios-star"></i></li>
                            ...
                            <div class="slide-item">
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="shop-left-sidebar.jsp">
                                            <img src="assets/images/product/small-size/7.jpg" alt="Umino's Product Image">
                                        </a>
                                    </div>
                                    <div class="product-content">
                                        <div class="product-desc_info">
        ...
        <!-- Umino's List Product Area End Here -->
